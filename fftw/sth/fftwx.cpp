...
inline double __cdecl CFFT_Wrapper::MatlabMod(double adblX,double adblY)
{
...
int __cdecl CFFT_Wrapper::WindowedWave(float *apInput, int anInputLength,int type)
{
	//1.check parameter
	if (NULL == apInput)
	{
...
int __cdecl CFFT_Wrapper::FFT(  double * apInput, 
						double * apOutPutReal, 
						double * apOutPutImg, 
						int anInputLength, 
						int& anOutputLength )
...
int __cdecl CFFT_Wrapper::FFT2( double * apInput, 
					   double * apOutPutAmp, 
...
int __cdecl CFFT_Wrapper::FFT5( double * apInput, 
					   double * apOutPutAmp, 
					   int anInputLength, 
					   int& anOutputLength,
					   BOOL abDividLength /*= 1*/,
...
int __cdecl CFFT_Wrapper::FFT4( double * apInput, 
										double * apOutPutAmp, 
										double * apOutPutPhase, 
										int anInputLength, 
										int& anOutputLength,
...
int __cdecl CFFT_Wrapper::Conv(double * apInputA, 
					   double * apInputB, 
					   double * apOutBuffer,
					   int anInputALength, 
					   int anInputBLength,
...
inline  double __cdecl CFFT_Wrapper::Round(double r)
{
	return (r > 0.0) ? floor(r + 0.5) : ceil(r - 0.5);
};

inline int __cdecl CFFT_Wrapper::IsZero(double adblData)
{
...
inline int __cdecl CFFT_Wrapper::Sign(double arData)
{
	if (arData>0)
	{
		return 1;
...
inline int __cdecl CFFT_Wrapper::CRC16(unsigned char *apInput, int anLength,unsigned short & asCRC)
{
	if (NULL == apInput)
	{
		return ERR_NULL_INPUT_BUFFER;
...
void __cdecl ExeCPUID(DWORD veax)  
{
	__asm
	{
		mov eax,veax
...
unsigned int __cdecl CFFT_Wrapper::GetCPUTYPE()
{
	if (G_HARDWARE_ID==-1)
	{
...
int __cdecl CFFT_Wrapper::LoadAllPlan()
{
...
int __cdecl CFFT_Wrapper::LoadPlan(int anInputLength)
{
	if (anInputLength<=_MIN_POINT)
	{
		return ERR_INVALID_INPUT_LENGTH;
...
int __cdecl CFFT_Wrapper::AppendAllPlan(char *  apPlan,int anCharLength)
{
	if (anCharLength<=0)
	{
		return ERR_INVALID_INPUT_LENGTH;
...
int __cdecl CFFT_Wrapper::SavePlan(int anInputLength)
{
	if (anInputLength<=_MIN_POINT)
	{
		return ERR_INVALID_INPUT_LENGTH;
...
inline int __cdecl CFFT_Wrapper::HASH( unsigned char *apInput, int anLength,unsigned int & anCRC )
{
	if (NULL == apInput)
	{
		return ERR_NULL_INPUT_BUFFER;
...
int __cdecl CFFT_Wrapper::SaveHanningConv(double * apOutBuffer,
								  int anInputALength, 
								  int & anOutputBufferLength, 
								  double  adblSum)
{
...
int __cdecl CFFT_Wrapper::LoadHanningConv(double * apOutBuffer, 
								  int anInputALength, 
								  int & anOutputBufferLength, 
								  double & adblSum)
{
...
int __cdecl CFFT_Wrapper::APFFT( double *apInput, 
...
int __cdecl CFFT_Wrapper::PreparePlan()
{
	...
	int& anOutputLength )
{
	...
	return CFFT_Wrapper::FFT(apInput,
		apOutPutReal,
		apOutPutImg,
		anInputLength,
		anOutputLength);
	...
	double adblPhaseDiff/*=90 */ )
{
	...
	return CFFT_Wrapper::FFT2(apInput,
		apOutPutAmp,
		apOutPutPhase,
		anInputLength,
		anOutputLength,
	...
	double adblRatio/*=2 */ )
{
	...
	return CFFT_Wrapper::FFT5(apInput,
		apOutPutAmp,
		anInputLength,
		anOutputLength,
		abDividLength,
	...
	double adblPhaseDiff/*=90*/ )
{
	...
	return CFFT_Wrapper::APFFT( apInput,
		apInputFreqSequenceToAdjust,
		apOutPutAmp,
		apOutPutPhase,
		apOutPutFrequence,
		adblSampleFreq,
		anInputLength,
		anInputFreqSequenceLength,
		anOutputLength,
		adblRatio,
		adblPhaseDiff);
...
STH_API int WindowedWave( float *apInput, int anInputLength,int type )
{
	...
	return CFFT_Wrapper::WindowedWave(apInput,anInputLength,type);
...
{
	return CFFT_Wrapper::Round(r);
}

STH_API  int Sign( double arData )
{
	return CFFT_Wrapper::Sign(arData);
}

STH_API  int IsZero( double adblData )
{
	return CFFT_Wrapper::IsZero(adblData);
}
	...
	double adblRatio/*=1*/ )
{
	...
	return CFFT_Wrapper::Conv(	apInputA,
		apInputB,
		apOutBuffer,
		anInputALength,
		anInputBLength,
...
{
	return CFFT_Wrapper::MatlabMod(adblX,adblY);
}


STH_API  int HASH( unsigned char *apInput, int anLength,unsigned int & anCRC )
{
	return CFFT_Wrapper::HASH(apInput,anLength,anCRC);
}
